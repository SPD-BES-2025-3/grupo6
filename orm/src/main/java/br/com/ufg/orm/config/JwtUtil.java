...
public class JwtUtil {
    ...
    @Value("${jwt.secret:minhachavesecretasuperseguraparaojwttoken123456789minhachavesecretasuperseguraparaojwttoken123456789}")
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (userDetails instanceof CustomUserPrincipal) {
            ...
            claims.put("nome", customUser.getNome());
            claims.put("permissoes", customUser.getPermissoes());
        }
